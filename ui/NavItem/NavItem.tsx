...
export default function NavItem({
  ...
  return (
    <li>
      <Link
        href={href}
        className="bg-gradient-to-tr from-primary-accent to-secondary-accent rounded-l-full rounded-r-full p-2.5 w-72 flex items-center justify-center transition hover:scale-110"
